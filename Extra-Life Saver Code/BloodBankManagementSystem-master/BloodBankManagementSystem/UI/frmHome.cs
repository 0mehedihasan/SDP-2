...
namespace BloodBankManagementSystem
{
    public partial class frmHome : Form
    {
        ...
        private void donateToToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmDonate donate = new frmDonate();
            donate.ShowDialog();
        }
        ...
        {
            MessageBox.Show("Advance Teaching Youtube Channel \n Email : struturedt@gmail.com","Message",MessageBoxButtons.OK,MessageBoxIcon.Information);
        }

        private void AdvanceTeachinglinkLabel_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.youtube.com/channel/UCORMBWmoMqv5iTFBazaeAYA/playlists?view_as=subscriber");  
        }
        ...
        {
            MessageBox.Show("This Application is Developed by Advance Teaching Youtube Channel \n Email:structuredt@gmail.com","Message",MessageBoxButtons.OK,MessageBoxIcon.Information);
